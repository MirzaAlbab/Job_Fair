...
@section('title')
    <title>Article | DPKKA - Universitas Airlangga</title>
@endsection
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <a href="{{ route('article-new') }}" class="btn btn-primary mb-3" role="button" aria-pressed="true"><i class="bi bi-plus-lg"></i> New Article</a>
                    ...
                    <td class="align-middle">                       
                      ...
                      <div class="modal fade" id="deleteFormModal" tabindex="-1">
                          ...
                          <div class="modal-content">
                              ...
                              <a href="{{ route('article') }}" class="btn btn-danger" role="button" aria-pressed="true">Delete</a>
                              </div>
                          </div>
                          </div>
