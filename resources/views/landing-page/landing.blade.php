                ...
                <div class="swiper-wrapper align-items-center">
                    @if (count($partners) > 0)
                        ...
                        @foreach ($partners as $sponsor)
                            <div class="swiper-slide d-flex align-items-center justify-content-center"><a
                                    href="{{ route('user-singlepartner', $sponsor->id) }}" target="_blank"><img
                                        src="{{ $sponsor->img }}" class="img-fluid" alt=""></a></div>
                    ...
                    @else
                        <div class="swiper-slide d-flex align-items-center justify-content-center"><img
                                src="{{ asset('assets/img/dummy.png') }}" class="img-fluid" alt=""></div>
                        <div class="swiper-slide d-flex align-items-center justify-content-center"><img
                                src="{{ asset('assets/img/dummy.png') }}" class="img-fluid" alt=""></div>
                    @endif
                </div>
                    ...
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                        <a href="{{ route('user-partners') }}">
                            <div class="box">
                                ...
                                <p>Presentasi perusahaan-perusahaan keren terkait informasi peluang dan prospek karier yang
                                    tersedia.</p>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            @if (count($rundown) > 0)
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="flush-headingOne">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                data-bs-target="#flush-collapse{{ $rd->id }}" aria-expanded="false"
                                                aria-controls="flush-collapseOne">
                                                {{ $rd->time }}
                                            </button>
                                        </h2>
                                        <div id="flush-collapse{{ $rd->id }}" class="accordion-collapse collapse"
                                ...
                                @else
                                    <div class="swiper-slide d-flex align-items-center justify-content-center"><img
                                            src="{{ asset('assets/img/comingsoonnnn.png') }}" class="img-fluid"
                                            alt=""></div>
                                    @endif
                        </div>
                        <!-- End Accordion without outline borders -->
                        ...
                        <div class="row align-self-center gy-4">
                            ...
                            <div class="col-md-4" data-aos="zoom-out" data-aos-delay="200">
                                <div class="feature-box d-flex align-items-center">
                                    ...
                                    <h3>Mendaftar pada menu "Daftar Sekarang" di website DPKKA atau klik <a
                                            href="https://dpkka.unair.ac.id/v2/jobseeker/registration"
                                            target="blank">Daftar</a> </h3>
                            ...
                            <div class="col-md-4" data-aos="zoom-out" data-aos-delay="300">
                                <div class="feature-box d-flex align-items-center">
                                    ...
                                    <h3>Mengisi form registrasi dengan memilih tipe keanggotaan sebagai “Mahasiswa / Alumni”
                                        atau “Umum”</h3>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4" data-aos="zoom-out" data-aos-delay="400">
                                <div class="feature-box d-flex align-items-center">
                                    ...
                                    <h3>Jika NIM Anda belum terdaftar silahkan mengisi form <a
                                            href="//bit.ly/RegistrasiNIMAlumni">berikut</a></h3>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4" data-aos="zoom-out" data-aos-delay="500">
                                <div class="feature-box d-flex align-items-center">
                                    ...
                                    <h3>Setelah melakukan registrasi, lengkapi data diri Anda yang nantinya digunakan
                                        sebagai CV Anda</h3>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4" data-aos="zoom-out" data-aos-delay="600">
                                <div class="feature-box d-flex align-items-center">
                                    ...
                                    <h3>Anda akan mendapatkan pesan melalui email yang sudah didaftarkan (cek spam bila
                                        tidak ada di kontak masuk)</h3>
                                </div>
                            </div>
                ...
                <div class="row gy-4 justify-content-center">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="count-box">
                            ...
                            <div>
                                <span data-purecounter-start="0" data-purecounter-end="{{ $countpartner }}"
                    ...
                    <div class="swiper-wrapper align-items-center justify-content-center mb-5">
                        @if (count($participant) > 0)
                            @foreach ($participant as $partici)
                                <div class="swiper-slide"><a href="{{ route('user-singlepartner', $partici->id) }}"
                                        target="_blank"><img src="{{ $partici->img }}" class="img-fluid" alt=""></a>
                                </div>
                            @endforeach
                        @else
                            <div class="swiper-slide"><a href="#"><img src="{{ asset('assets/img/dummy.png') }}"
                                ...
                                <div class="gallery-wrap">
                                    ...
                                    <div class="gallery-info">
                                        <div class="gallery-links">
                                            <a href="{{ $g->img }}" data-gallery="portfolioGallery"
                                                class="portfokio-lightbox"><i class="bi-zoom-in position-absolute"
                                                    style="font-size: 1rem;"></i></a>
                                            <a href="{{ route('user-gallery') }}" title="More Details"><i
                                                    class="bi bi-link position-absolute"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="accordion accordion-flush" id="faqlist2">
                            @foreach ($faqs[1] as $faq)
                                <div class="accordion-item">
                                    ...
                                    <div id="faq2-content-{{ $faq->id }}" class="accordion-collapse collapse"
